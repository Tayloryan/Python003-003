...
class CatSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for movie in movies:
            ...
            movie_name = ""
            movie_type = ""
            movie_plan_time = movie.xpath(''./div[@class="movie-hover-title movie-hover-brief"]/text())
            movie_performer = ""
            ...
            for span_node in span_list:
                print(span_node)
                span_node_plan_time = span_node.xpath('../../div[@class="movie-hover-title movie-hover-brief"]/text()')
                print(span_node_plan_time)
